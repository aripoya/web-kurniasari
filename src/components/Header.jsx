...
const Header = () => {
    ...
    return <>
        <header className="py-2 px-4 fixed w-full bg-white z-50">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex justify-between items-center gap-10">
                    ...
                    <nav className="space-x-12 hidden md:flex text-sm">
                        <Each
                            data={MENUS}
                            render={menu => <a href={menu.url} className="hover:text-green transition-all duration-300 text-black">{menu.link}</a>}
                        />
                    </nav>
                </div>
                <a
