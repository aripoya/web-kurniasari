...
const NewProductArrival = () => {
    ...
    return (
        <div id="new-product-arrival" className="justify-center">
            <section className="flex flex-col md:flex-row bg-green-100 mx-auto">
                ...
                <div className="flex overflow-x-scroll md:max-w-[84vw] no-scrollbar bg-green-100 pb-10 md:pb-0 px-4 md:px-0">
                    <Each
                        data={PRODUCT}
                        render={product => (
                            <div style={{ backgroundImage: `url('${product.thumbnail}')` }} className={`new-product-arrival-item bg-cover bg-center shadow-md flex-shrink-0 min-w-[300px] md:min-w-[342px]  min-h-[515px] md:w-auto relative`}>
